//! Shared helpers for Nickel package build scripts.

use std::{env, fs::File, path::PathBuf};

const WINDOWS_ICON_SIZES: [u32; 7] = [16, 24, 32, 48, 64, 128, 256];

/// Generates a multi-resolution Windows icon and embeds it in the package executable.
///
/// `source` is resolved relative to the calling package's manifest directory.
pub fn embed_windows_icon(source: &str, output_name: &str) {
