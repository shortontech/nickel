...
pub(super) struct SettingsApp {
    ...
    pub(super) drag_layout_origin: Option<(i32, i32)>,
    ...
    pub(super) using_mock_displays: bool,
    pub(super) display_resolution_select_expanded: bool,
    pub(super) display_refresh_select_expanded: bool,
...
impl Default for SettingsApp {
    fn default() -> Self {
        ...
        let displays = vec![
            DisplayCard {
                connector: "MOCK-1".into(),
                name: "Mock display A".into(),
                detail: "SIMULATED DISPLAY  1280 X 800".into(),
                logical_width: 1280,
                logical_height: 800,
                logical_x: 0,
                logical_y: 0,
            ...
            DisplayCard {
                connector: "MOCK-2".into(),
                name: "Mock display B".into(),
                detail: "SIMULATED DISPLAY  1600 X 900".into(),
                logical_width: 1600,
                logical_height: 900,
                logical_x: 1280,
                logical_y: 0,
        ...
        Self {
            ...
            using_mock_displays: true,
            display_resolution_select_expanded: false,
            display_refresh_select_expanded: false,
