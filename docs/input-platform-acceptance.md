...
Exact current-tip results below were recorded at `2843cb4`. Older focused evidence remains listed
...
Pass: 456 passed, 0 failed, 6 ignored. This covers the integrated session authority route,
