...
Exact current-tip results below were recorded at `8811cd2`. Older focused evidence remains listed
...
Pass: 452 passed, 0 failed, 6 ignored. This covers the integrated session authority route,
