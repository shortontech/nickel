...
| Platform-neutral UI | active-widget identity, shared pointer/keyboard/controller activation prefix, handled/fallback disposition | pass: 396 passed, 2 ignored | pass | not applicable | none for enumerated headless transitions |
...
Exact current-tip results below were recorded at `ce55893`. Older focused evidence remains listed
...
`nickel-session-protocol` 55/0, `nickel-ui` 396/0 with 2 ignored, and
