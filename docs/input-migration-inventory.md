...
- SDL and winit event imports inside the shared adapters or binaries that immediately pass the whole
  event to those adapters.
...
```sh
rg -n 'sdl3::keyboard::|winit::keyboard::|gilrs::|KBDLLHOOKSTRUCT|RegisterHotKey|Keysym' \
