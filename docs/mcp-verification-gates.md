...
- Snapshot `unavailable_domains` currently includes native GPU timing,
  GPU/shared cache resources, Windows DWM pixel readback and maintenance collection,
